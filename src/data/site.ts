...
export const works = [
  ...
  },
  {
    ...
    title: '万花筒 · 点击生成',
    eyebrow: '生成艺术 · 实时计算',
    href: '/games/kaleidoscope.html',
    image: '/assets/img/games/kaleidoscope.webp',
    summary: '点击即运算：把画面折进 N 面镜子的基本域再逆映射回彩色玻璃源图——纵向定镜面数、横向定色相，配乐随图案一起换调。',
    tags: ['Canvas', '数学之美', 'Web Audio'],
    status: '站内新作',
  },
  {
    id: 'mini-games',
    ...
    summary: '万花筒、数字扫雷与像素打砖块：把小规则做成可玩的网页作品。',
