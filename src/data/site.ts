...
export const works = [
  ...
  {
    id: 'fireworks-kaleidoscope',
    title: '焰火效果万花筒',
    eyebrow: '生成艺术 · 群论之美',
    href: '/games/fireworks-kaleidoscope.html',
    image: '/assets/img/games/fireworks-kaleidoscope.webp',
    summary: '点一下，绽放一朵对称焰火：图形被 D_N 对称群实时复制成 2N 份，可多点触控各自绽放，配乐按五声音阶实时合成、每次绽放换调。',
    tags: ['Canvas', 'D_N 对称群', 'Web Audio'],
    status: '站内新作',
  },
  {
    id: 'retro-kaleidoscope',
    title: '复古万花筒',
    eyebrow: '生成艺术 · 万象镜',
    href: '/games/retro-kaleidoscope/',
    image: '/assets/img/games/retro-kaleidoscope.webp',
    summary: '点击重组光与对称：6–20 重镜像、转速可调，暮火／深海／幽兰／银白四套配色随选，可暂停、可导出 PNG。',
    tags: ['Canvas', '镜像扇区', '复古配色'],
    status: '站内新作',
  },
  {
    id: 'mini-games',
    ...
    summary: '两支万花筒、数字扫雷与像素打砖块：把小规则做成可玩的网页作品。',
